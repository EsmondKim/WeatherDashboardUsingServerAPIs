$(document).ready(function () {
      ...
      $.ajax({
        ...
        $.ajax({
          ...
          let queryURLDaily =
            ...
            "&lon=" +
            uvLon +
            "&exclude=current,minutely,hourly,alerts&appid=87665d60f93b269a6c1aa2b881ea7347";
          ...
          $.ajax({
            ...
            let day1TempToF = (day1Temp - 273.15) * 1.8 + 32;
            ...
            let day2TempToF = (day2Temp - 273.15) * 1.8 + 32;
            ...
            let day3TempToF = (day3Temp - 273.15) * 1.8 + 32;
            ...
            let day4TempToF = (day4Temp - 273.15) * 1.8 + 32;
            ...
            let day5TempToF = (day5Temp - 273.15) * 1.8 + 32;
            ...
            let dayOneTempF = (dayOneTemp - 273.15) * 1.8 + 32;
            if (dayOneTempF < 30) {
            ...
            let dayTwoTempF = (dayTwoTemp - 273.15) * 1.8 + 32;
            if (dayTwoTempF < 30) {
            ...
            let dayThreeTempF = (dayThreeTemp - 273.15) * 1.8 + 32;
            if (dayThreeTempF < 30) {
            ...
            let dayFourTempF = (dayFourTemp - 273.15) * 1.8 + 32;
            if (dayFourTempF < 30) {
            ...
            let dayFiveTempF = (dayFiveTemp - 273.15) * 1.8 + 32;
            if (dayFiveTempF < 30) {
  ...
  $("#btn").on("click", function () {
    ...
    $("#citiesList").append(
      '<li style="text-align: center;" class="city-name list-group-item" data-name=' +
        queryCity +
        ">" +
        queryCity +
        "</li>"
  ...
  function getWeatherCitiesList() {
    ...
    window.localStorage.setItem(
      "citySearched",
      JSON.stringify(queryFromCitiesList)
    );
